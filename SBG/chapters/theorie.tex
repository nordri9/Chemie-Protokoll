...
Dabei entstehen konjugierte Säure-Base-Paare. Je stärker eine Säure, desto schwächer ist ihre konjugierte Base \cite{skript}.
...
Die Säurestärke wird durch die Säurekonstante beschrieben \cite{skript}:
\begin{equation}
    K_\mathrm{S} =
...
Für konjugierte Säure-Base-Paare gilt \cite{atkins_kurzlehrbuch_2020}:
