...
Ein Universalindikator ist ein Gemisch aus mehreren Säure-Base-Indikatoren mit unterschiedlichen pKS-Werten und damit unterschiedlichen Umschlagsbereichen. Dadurch überdeckt er einen großen pH-Bereich und ermöglicht eine kontinuierliche Farbskala von stark sauer bis stark basisch.

Der Vorteil dieses Indikators liegt in der breiten Anwendbarkeit, da nahezu der gesamte pH-Bereich abgebildet werden kann. Allerdings ist die Genauigkeit im Vergleich zu Einzelindikatoren geringer, da die Farbzuordnung nur eine grobe Abschätzung des pH-Wertes erlaubt und keine exakte Bestimmung möglich ist.
\subsubsection{Fehlerbetrachtung}
