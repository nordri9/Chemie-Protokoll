...
Für die nichtmetallischen Oxide bzw. Oxid-Hydroxide dominiert somit zunehmend die Bildung von Oxoniumionen in Wasser. Für die Elemente Phosphor, Schwefel und Chlor existieren keine klassischen, ionischen Hydroxide, da es sich um Nichtmetalle mit hoher Elektronegativität handelt. Stattdessen bilden sie kovalent gebundene Oxosäuren, in denen keine frei dissoziierenden Hydroxidionen (\ce{OH^-}) vorliegen. Daher treten diese Verbindungen nicht als „reine Hydroxide“, sondern als Säuren wie \ce{H3PO4}, \ce{H2SO4} und \ce{HClO3} auf. Siliciumdioxid kann formal als schwache Kieselsäure beschrieben werden, wie in \eqref{eq:silicic_acid} gezeigt.
