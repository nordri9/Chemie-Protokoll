...
\ihead{Gruppe 9a: Robin Kühnberger, Felix Naraschewski, \\ Felix Winkler}
\ohead{\today}
\ifoot{9a}
...
\newcommand{\reqref}[1]{Reaktionsgleichung~(\ref{#1})}
  ...
  \begin{center}
    ...
    \begin{table}[H]
      ...
      \begin{tabular}{>{\bfseries}p{4cm}p{8cm}}
        Verfasser:      & Robin Kühnberger, Felix Naraschewski, Felix Winkler                                                                                                                                                                                      \\
        Matrikelnummer: & 3714445, 3836776, 3686984                                                                                                                                                                                                                \\
        E-Mail-Adresse: & \href{mailto:st189389@stud.uni-stuttgart.de}{st189389@stud.uni-stuttgart.de}, \href{mailto:st197995@stud.uni-stuttgart.de}{st197995@stud.uni-stuttgart.de}, \href{mailto:st185583@stud.uni-stuttgart.de}{st185583@stud.uni-stuttgart.de} \\
        Assistent:      & Erwir Dzakulic                                                                                                                                                                                                                           \\
        Erstabgabe:     & 24. Juni 2026                                                                                                                                                                                                                            \\
        Zweitabgabe     & 6. Juli 2026                                                                                                                                                                                                                             \\
        Drittabgabe     & \today                                                                                                                                                                                                                                   \\
      \end{tabular}
    \end{table}
  \end{center}
