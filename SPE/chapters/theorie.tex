...
\begin{equation}
  ...
  \label{eq:energie}
\end{equation}
wobei $h = \SI{6,62607015e-34}{J \cdot s}$ das Plancksche Wirkungsquantum ist. Wie in Gleichung \ref{eq:energie} zu erkennen, sind Energie und Wellenlänge somit invers proportional zueinander.
