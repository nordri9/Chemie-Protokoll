...
\begin{equation}
  ...
  \label{eq:energie}
\end{equation}
wobei $h = \SI{6,62607015e-34}{Js}$ das Plancksche Wirkungsquantum, $f$ die Frequenz, $\lambda$ die Wellenlänge und $c = \SI{299792458}{\frac{m}{s}}$ die Vakuumlichtgeschwindigkeit ist \cite[13]{gobel_new_2019}. Wie in Gleichung~\ref{eq:energie} zu erkennen, sind Energie und Wellenlänge invers proportional zueinander.
